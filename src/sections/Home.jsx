...
import Photu from "../assets/avator.png"


const socials =[
    // {Icon : FaXTwitter , label: "X", href: ""},
     {Icon : FaGithub , label: "XGitHub", href: "https://github.com/pawar0mahesh"},
     {Icon : FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/mahesh-singh-pawar-141b92288?utm_source=share_via&utm_content=profile&utm_medium=member_android"}
...
export default function Home(){
    const roles =useMemo(()=> ["Web Development", "UI/UX Designing"], [])
    ...
    return(
        <section id="home" className="w-full h-screen relative bg-black overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                rounded-full
                bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8de]
            ...
            <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
                <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
                    <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
                        ...
                        <motion.div 
                        className="mb-3 text-xl sm:text-2xl md:text-4xl font-semibold text-white tracking-wide min-h-[1.6em]"
                        ...
                        >
                            ...
                            >
                              I design, build, and bring ideas to life on the web — creating clean, responsive, and user-friendly digital experiences.
                ...
                <div className="relative hidden lg:block">
                    ...
                    style={{
                        right:"50px", width:"min(22vw, 410px)" , height:"min(40vw ,760px)", borderRadius:"50%",
                        filter: "blur(38px" , opacity:0.32,
                        background: "conic-gradient(from 0deg, #1cd8d2, #00bf8f , #302b63 , #1cd8d2)"
                    }}
                    />
                    <motion.img src={Photu} alt="Mahesh Pawar"
