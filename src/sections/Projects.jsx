...
import photo1 from '../assets/pic01.png';
import img1 from '../assets/imge01.png';
import img2 from '../assets/imge2.jpg';
import img3 from '../assets/imge3.png';
    ...
    () => [
      {
        ...
        link: "https://github.com/pawar0mahesh/Disaster-management-system",
        bgColor: "#42af72",
        image: isMobile ? photo1 : img1, // use mobile or desktop image
      },
      {
        title: "Pinterest clone",
        link: "https://github.com/pawar0mahesh/pinterest-clone",
        bgColor: "#d22730d9",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "Art Portfolio",
        link: "https://github.com/pawar0mahesh/Art-portfolio",
        bgColor: "#e7ca38e7",
      ...
      >
        <AnimatePresence mode="wait">
          {activeIndex === idx && (
            ...
            className={`block text-center textext-4xl sm:text-6xl md:text-7xl lg:text-8xl text-white/95 sm:absolute sm:-top-20 sm:left-[35%] lg:left-[-5%] sm:mb-0
