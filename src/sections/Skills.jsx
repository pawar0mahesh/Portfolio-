...
import { SiAngular, SiDocker, SiFastapi, SiJavascript, SiMongodb, SiMysql, SiNextdotjs, SiPython, SiTailwindcss, SiTypescript } from "react-icons/si";
  ...
  return(
    ...
    <section ref={sectionRef} id="skills" className="h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden">
      <div className='absolute inset-0 pointer-events-none'>
        ...
        "/>
        <div className="absolute botom-1/4 right-0 w-[300px] h-[300px] rounded-full bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[1cd8d2]
      ...
      <motion.p className="text-white/90 mt-2 mb-8 text-base sm:text-lg z-10 "
