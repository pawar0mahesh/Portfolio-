      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        <div className="flex-1 flex flex-col justify-center text-center md:text-left">
          ...
          <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
            I'm a passionate Full Stack Developer and B.Tech CSE student who loves building modern, scalable, and user-friendly web applications. I enjoy turning ideas into real-world digital solutions while continuously learning and improving my craft.
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
            ...
            text-black font-semibold px-5 py-3 hover:bg-gray-200 transition
            ">View Projects</a>
            <a href="#contact" className="inline-flex items-center justify-center rounded-lg border border-white/20 text-white px-5
            py-3 bg-white/10 hover:bg-white/20 transition
            ">Get in Touch</a>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
           I’m Mahesh Pawar, a B.Tech Computer Science student and a passionate Full Stack Developer. I enjoy building modern, responsive, and user-friendly web applications that bring ideas to life. From designing clean frontends to developing efficient backend systems, I love working across the full stack.
          </p>
